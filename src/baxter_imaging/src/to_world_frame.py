...
class WorldFrameTransformer:
    def __init__(self, sub_topic, pub_topic, cam1_frame_id, cam2_frame_id, ar_tag):
        ...
        self.sub = rospy.Subscriber(sub_topic, BallLoc, self.BallLocCallback)
...
def main():
    ...
    wft = WorldFrameTransformer("/kinect/ball/location", "/world/ball/location", "/camera_link", "/reference/left_hand_camera", 15)
    rospy.spin()
